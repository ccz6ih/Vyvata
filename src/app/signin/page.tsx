  ...
  return (
    <main className="min-h-dvh flex items-center justify-center px-6" style={{ background: "#0B1F3B" }}>
      <div className="w-full max-w-sm">
        ...
        >
          <ArrowLeft size={12} /> Back to Vyvata
        </Link>
        ...
        {sent ? (
          ...
          >
            ...
            <p className="text-xs" style={{ color: "#C9D6DF", fontFamily: "Inter, sans-serif", lineHeight: 1.6 }}>
              If that email is valid, we've sent you a sign-in link. It expires in 15 minutes.
            </p>
          </div>
        ) : (
          <form
          ...
          >
            <label className="block space-y-2">
              <span className="text-xs font-medium" style={{ color: "#7A90A8" }}>Email</span>
            ...
            <p className="text-xs text-center pt-1" style={{ color: "#4a6080", fontFamily: "Inter, sans-serif" }}>
              Practitioner? <Link href="/practitioner/login" className="underline" style={{ color: "#14B8A6" }}>Sign in here</Link>
            </p>
          </form>
        )}
      </div>
